...
{
    // Logo
    $this->Image("$GLOBALS[fname]",90,6,40);
    // Arial bold 15
...
$y = $this->GetY() + 10;
$this->Cell(110,5,"     " .$medtec[1],'0',0,'L',true);
...
if(($tot=="Special Tests") || ($tot=="Semen Analysis") || ($tot=="Differential Count") || ($tot=="PROTIME") || ($tot=="Dengue Duo") || ($tot=="OGTT") || ($tot=="Electrolytes") || ($tot=="Salmonella Typhi IgG and IgM")|| ($tot=="T3 T4 and TSH")){
...
$pdf->Cell(150,6,"Patient No. :  $patientid",0,0,'L',true);
$y = $pdf->GetY() + 5;
$pdf->Line(32,$y,48,$y);
$yy = $pdf->GetY();

$pdf->Cell(50,6,"Lab No : $transactionid",0,0,'L',true);
$pdf->Line(176,$y,193,$y);
$pdf->Ln();

$pdf->Cell(150,6,"",0,0,'L',true);
$y = $pdf->GetY() + 5;

$pdf->Cell(50,6,"Date : " .$daterelease,0,0,'L',true);
$pdf->Line(172,$y,193,$y);
$pdf->Ln();

$pdf->SetFont('Arial','',11);
$pdf->Cell(27,6,'Patient Name: ',0,0,L,true);
$pdf->SetFont('Arial','',10);
$firstnamestring = utf8_decode($datas[firstname]);
$lastnamestring = utf8_decode($datas[lastname]);
$pdf->Cell(73,6,"$lastnamestring".","." $firstnamestring".",". " $datas[mi]",0,0,'L',true);
...
$pdf->Line(120,$y,137,$y);
$pdf->Cell(25,6,"Sex : $sex",0,0,'L',true);
$pdf->Line(150,$y,165,$y);
$pdf->Cell(30,6,"C.S. : $cs",0,0,'L',true);
$pdf->Line(175,$y,193,$y);
$pdf->Ln();
$pdf->Cell(17,6,"Address :",0,0,'L',true);
$pdf->SetFont('Arial','',10.5);
$pdf->Cell(83,6,"$address",0,0,'L',true);
$y = $pdf->GetY() + 5;
$pdf->Line(29,$y,107,$y);
$pdf->SetFont('Arial','',11);
$pdf->Cell(105,6,"Requesting Physician : $rp",0,0,'L',true);
$pdf->Line(150,$y,193,$y);
